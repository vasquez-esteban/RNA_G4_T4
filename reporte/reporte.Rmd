...
**Contribuciones:** Estrategias diferenciadas de prompt engineering creativo, análisis de colaboración humano-IA, y sistemas de filtrado ético.
...
- **Temperatura:** 0.8 (equilibrio creatividad-coherencia)
...
**Gestión de Estado:** Preservación de entradas durante errores y re-renders usando `st.session_state`.
...
- **Role-playing:** Contextualización como "escritor profesional especializado"
...
El prompt fundamental establece al modelo como escritor profesional especializado en el género específico solicitado, incorporando el tono emocional deseado. Las consideraciones específicas para cada género proporcionan contexto relevante sin limitar creatividad. La estructura sugerida incluye tres fases narrativas: introducción que presenta escenario y personajes, desarrollo que introduce conflicto y obstáculos, y resolución que cierra satisfactoriamente la historia.
